...
tinyMCE.init({
  ...
  theme_advanced_buttons1:((tinyMCE.isSafari) ? "" : "bold, italic, underline, spacer, bullist, numlist, spacer, outdent, indent, spacer, undo, redo, spacer, link, unlink, image, spacer, code"),
